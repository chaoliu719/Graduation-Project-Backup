...
void *list_remove(List *free_list, void *block)
{
    ...
    if (((void *)0) != prev_free)
    {
        {size_t ** tmp = (size_t **) ((void *) ((char *)(prev_free) + sizeof(size_t) + sizeof(size_t *))); *tmp = (size_t *)(next_free);};
    }

    if (((void *)0) != next_free)
    {
        {size_t ** tmp = (size_t **) ((void *) ((char *)(next_free) + sizeof(size_t))); *tmp = (size_t *)(prev_free);};
    }
...
void list_insert_after(List *free_list, void *prev_block, void *block)
{
    if (prev_block == ((void *)0))
    {
        ...
        {size_t ** tmp = (size_t **) ((void *) ((char *)(block) + sizeof(size_t) + sizeof(size_t *))); *tmp = (size_t *)(free_list->head);};
        {size_t ** tmp = (size_t **) ((void *) ((char *)(block) + sizeof(size_t))); *tmp = (size_t *)(((void *)0));};

        if (0 != free_list->cnt)
        {
            {size_t ** tmp = (size_t **) ((void *) ((char *)(free_list->head) + sizeof(size_t))); *tmp = (size_t *)(block);};
        }
        else
        {
    ...
    else
    {
        ...
        {size_t ** tmp = (size_t **) ((void *) ((char *)(block) + sizeof(size_t) + sizeof(size_t *))); *tmp = (size_t *)(next_free);};
        {size_t ** tmp = (size_t **) ((void *) ((char *)(block) + sizeof(size_t))); *tmp = (size_t *)(prev_block);};
        {size_t ** tmp = (size_t **) ((void *) ((char *)(prev_block) + sizeof(size_t) + sizeof(size_t *))); *tmp = (size_t *)(block);};
        if (next_free != ((void *)0))
        {
            {size_t ** tmp = (size_t **) ((void *) ((char *)(next_free) + sizeof(size_t))); *tmp = (size_t *)(block);};
        }
        else
        {
            free_list->tail = block;
...
void *mm_realloc(void *ptr, size_t free_size)
{
    ...
    if (new_size < (*(size_t *)(origin) & ~0x7u))
    {
        ...
        {
            new_size = (*(size_t *)(origin) & ~0x7u);
        }
    }
    else if (new_size > (*(size_t *)(origin) & ~0x7u))
    {
...
void *_mm_malloc(List *free_list, size_t new_size, void *(*list_find)(List *, size_t))
{
    ...
    return ((void *)((char *)(now_block) + ((((sizeof(size_t)) + (8 -1)) & ~0x7u))));
}
                  ...
                  void (*free)(List *, void *))
{
    ...
    if (new_size == (*(size_t *)(old_block) & ~0x7u))
    {
        ...
        return ((void *)((char *)(old_block) + ((((sizeof(size_t)) + (8 -1)) & ~0x7u))));
    }
    else if (new_size < (*(size_t *)(old_block) & ~0x7u))
    {
    ...
    else
    {
        ...
        {size_t ** tmp = (size_t **) ((void *) ((char *)(new_block) + sizeof(size_t))); *tmp = (size_t *)(stage_pointer[0]);};
        {size_t ** tmp = (size_t **) ((void *) ((char *)(new_block) + sizeof(size_t) + sizeof(size_t *))); *tmp = (size_t *)(stage_pointer[1]);};

        recycle(free_list, new_block, new_size, free);

        return ((void *)((char *)(new_block) + ((((sizeof(size_t)) + (8 -1)) & ~0x7u))));
    }
}
...
void *find_best_fit(List *free_list, size_t new_size)
{
    ...
    for (now_block = free_list->head; now_block != ((void *)0); now_block = ((void *) *(size_t *)((void *) ((char *)(now_block) + sizeof(size_t) + sizeof(size_t *)))))
    {
        ...
        else if ((*(size_t *)(now_block) & ~0x7u) > new_size && min_diff > (*(size_t *)(now_block) & ~0x7u) - new_size)
        {
...
void ao_free(List *free_list, void *new_block)
{
    ...
    for (old_block = free_list->head; old_block != ((void *)0);)
    {
        ...
        else
        {
            ...
            else if (prev_block == ((void *)0) && ((void *) *(size_t *)((void *) ((char *)(old_block) + sizeof(size_t) + sizeof(size_t *)))) > new_block)
            {
    ...
    while (1)
    {
        ...
        if (flag == 0)
        {
            ...
            else if (min_p != mem_heap_hi())
            {
                ...
                {
                    printf("status: %s, size: %lx\n\n", "busy",
                           (char *) mem_heap_hi() - (char *) min_p - (*(size_t *)(min_p) & ~0x7u) + 1);
