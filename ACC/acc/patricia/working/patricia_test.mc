...
extern int callrpc (const char *__host, const u_long __prognum,
      ...
      const xdrproc_t __outproc, char *__out) __attribute__ ((__nothrow__ ));
...
# 24 "/usr/include/rpc/auth_des.h" 3 4
...
extern int getsecretkey (const char *__name, char *__key,
    const char *__passwd) __attribute__ ((__nothrow__ ));
