...
#line 43 "proxy.c"
Getnameinfo((( SA *)(&clientaddr)), clientlen, hostname, 8192, port, 8192, 0); 
#line 44 "proxy.c"
...
# 7808 "proxy.c"
  ...
  void __utac_acc__aop__2 (void* connfd_p  , struct JoinPoint * );


  void doit (void* connfd_p  ) ; 
  void doitutac__exec__ori (void* connfd_p  ) ; 
void ** doit_utac__exec__wrapper_proxy_0 (struct JoinPoint * this);  
 

# 7820 "proxy.c"
void ** doit_utac__exec__wrapper_proxy_0 (struct JoinPoint * this) { 
 
void* * a0  = ( void* *) (this->args[ 0 ]); 
  
doitutac__exec__ori ( *a0 ); 
...
void** __utac__arg0 = &connfd_p; 
const char * __utac__argtype0 = "void*"; 
 void * __utac__args[1]; 
...
this.fp = &(doit_utac__exec__wrapper_proxy_0);
this.retValue = __utac__retp ; 
this.retType ="void" ; 
 { 
void* __utac__ad__arg1 = connfd_p ; 
__utac_acc__aop__2(__utac__ad__arg1 ,&this );
...
#line 60 "proxy.c"
if (connfd_p == (((void *)0)) || (*((int *)connfd_p)) < 0){
{ 
#line 57 "proxy.c"
return ; 
 } }
...
#line 64 "proxy.c"
char endserver_http_header[8192];
#line 66 "proxy.c"

#line 66 "proxy.c"
char hostname[8192],path[8192];
#line 67 "proxy.c"
...
#line 99 "proxy.c"
 size_t n;
#line 100 "proxy.c"
while((n = Rio_readlineb((&server_rio), buf, 8192)) != 0) { { 
#line 102 "proxy.c"
...
#line 111 "proxy.c"
char buf[8192],request_hdr[8192],other_hdr[8192],host_hdr[8192];
#line 113 "proxy.c"
sprintf(request_hdr, requestlint_hdr_format, path); 
#line 115 "proxy.c"
while(Rio_readlineb(client_rio, buf, 8192) > 0) { { 
#line 120 "proxy.c"
if (__extension__ ({ 
#line 117 "proxy.c"
...
#line 117 "proxy.c"
((__builtin_constant_p(buf) && __builtin_constant_p(endof_hdr) && (__s1_len = __builtin_strlen(buf) , __s2_len = __builtin_strlen(endof_hdr) , ((!((( size_t )((const void *)((buf) + 1))) - (( size_t )((const void *)(buf))) == 1)) || __s1_len >= 4) && ((!((( size_t )((const void *)((endof_hdr) + 1))) - (( size_t )((const void *)(endof_hdr))) == 1)) || __s2_len >= 4))?__builtin_strcmp(buf, endof_hdr):((__builtin_constant_p(buf) && ((( size_t )((const void *)((buf) + 1))) - (( size_t )((const void *)(buf))) == 1) && (__s1_len = __builtin_strlen(buf) , __s1_len < 4)?((__builtin_constant_p(endof_hdr) && ((( size_t )((const void *)((endof_hdr) + 1))) - (( size_t )((const void *)(endof_hdr))) == 1)?__builtin_strcmp(buf, endof_hdr):(__extension__ ({ 
#line 117 "proxy.c"

#line 117 "proxy.c"
const unsigned char *__s2 = ((const unsigned char *)((const char *)(endof_hdr)));
#line 117 "proxy.c"

#line 117 "proxy.c"
int __result = ((((const unsigned char *)((const char *)(buf))))[0] - __s2[0]);
#line 117 "proxy.c"
if (__s1_len > 0 && __result == 0){
{ 
#line 117 "proxy.c"
__result = ((((const unsigned char *)((const char *)(buf))))[1] - __s2[1]); 
#line 117 "proxy.c"
if (__s1_len > 1 && __result == 0){
{ 
#line 117 "proxy.c"
__result = ((((const unsigned char *)((const char *)(buf))))[2] - __s2[2]); 
#line 117 "proxy.c"
if (__s1_len > 2 && __result == 0){
__result = ((((const unsigned char *)((const char *)(buf))))[3] - __s2[3]); }} }} }
#line 117 "proxy.c"
__result; } )))):((__builtin_constant_p(endof_hdr) && ((( size_t )((const void *)((endof_hdr) + 1))) - (( size_t )((const void *)(endof_hdr))) == 1) && (__s2_len = __builtin_strlen(endof_hdr) , __s2_len < 4)?((__builtin_constant_p(buf) && ((( size_t )((const void *)((buf) + 1))) - (( size_t )((const void *)(buf))) == 1)?__builtin_strcmp(buf, endof_hdr):((-(__extension__ ({ 
#line 117 "proxy.c"

#line 117 "proxy.c"
const unsigned char *__s2 = ((const unsigned char *)((const char *)(buf)));
#line 117 "proxy.c"

#line 117 "proxy.c"
int __result = ((((const unsigned char *)((const char *)(endof_hdr))))[0] - __s2[0]);
#line 117 "proxy.c"
if (__s2_len > 0 && __result == 0){
{ 
#line 117 "proxy.c"
__result = ((((const unsigned char *)((const char *)(endof_hdr))))[1] - __s2[1]); 
#line 117 "proxy.c"
if (__s2_len > 1 && __result == 0){
{ 
#line 117 "proxy.c"
__result = ((((const unsigned char *)((const char *)(endof_hdr))))[2] - __s2[2]); 
#line 117 "proxy.c"
if (__s2_len > 2 && __result == 0){
__result = ((((const unsigned char *)((const char *)(endof_hdr))))[3] - __s2[3]); }} }} }
#line 117 "proxy.c"
__result; } )))))):__builtin_strcmp(buf, endof_hdr))))))); } ) == 0){
break; }
#line 120 "proxy.c"
...
# 8076 "proxy.c"
retValue_acc = Open_clientfd(hostname, portStr);
# 8078 "proxy.c"
return (int )retValue_acc;
...
#line 167 "proxy.c"
sscanf(pos2 + 1, "%d%s", port, path); } }else{
{ 
#line 171 "proxy.c"
pos2 = strstr(pos, "/"); 
#line 172 "proxy.c"
