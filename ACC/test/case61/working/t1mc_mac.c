...
# 397 "t1mc_mac.c"
retValue_acc = ((data << 8) | (data >> 8));
# 399 "t1mc_mac.c"
return (uint16_t )retValue_acc;
...
# 500 "t1mc_mac.c"
retValue_acc = _OSSwapInt16(result);
# 502 "t1mc_mac.c"
return (uint16_t )retValue_acc;
...
# 537 "t1mc_mac.c"
retValue_acc = _OSSwapInt32(result);
# 539 "t1mc_mac.c"
return (uint32_t )retValue_acc;
...
# 574 "t1mc_mac.c"
retValue_acc = _OSSwapInt64(result);
# 576 "t1mc_mac.c"
return (uint64_t )retValue_acc;
...
# 669 "t1mc_mac.c"
retValue_acc = OSLittleEndian;
# 671 "t1mc_mac.c"
return (int32_t )retValue_acc;
...
# 700 "t1mc_mac.c"
retValue_acc = (*((volatile  uint16_t *)((( uintptr_t )base) + byteOffset)));
# 702 "t1mc_mac.c"
return (uint16_t )retValue_acc;
...
# 731 "t1mc_mac.c"
retValue_acc = (*((volatile  uint32_t *)((( uintptr_t )base) + byteOffset)));
# 733 "t1mc_mac.c"
return (uint32_t )retValue_acc;
...
# 762 "t1mc_mac.c"
retValue_acc = (*((volatile  uint64_t *)((( uintptr_t )base) + byteOffset)));
# 764 "t1mc_mac.c"
return (uint64_t )retValue_acc;
...
void *valloc( size_t ); 
static inline void*  malloc__t1mc_mac__0 (size_t __utac__para0  )  ; 
...
# 1145 "t1mc_mac.c"
  ...
  void __utac_acc__t1ac_mac__1 (void);

  void* malloc (size_t __utac__para0  ) ; 
...
{
__utac_acc__t1ac_mac__1();

}

# 1163 "t1mc_mac.c"
retValue_acc = malloc ( __utac__para0 ) ;  

# 1166 "t1mc_mac.c"
return (void* )retValue_acc;
}
 
static inline void*  malloc__t1mc_mac__1 (size_t __utac__para0  )  ; 
