...
#line 3 "t7ac.acc"
 inline void __utac_acc__t7ac__2(void) { 
...
#line 6 "t7ac.acc"
 inline void __utac_acc__t7ac__3(void) { 
...
#line 9 "t7ac.acc"
 inline void __utac_acc__t7ac__4(void) { 
...
#line 13 "t7ac.acc"
 inline void __utac_acc__t7ac__5(   struct JoinPoint *  this  )  {
...
p = (jmp_buf *)excep->jumpbuf; 
 ...
 int __utac__cflow_t7ac_2 (int x, int y) { 
 static int level = 0; 
 switch(x) { 
 case 1: level ++; break ; 
 case 2: level -- ; break; 
 ...
 int __utac__cflow_t7ac_1 (int x, int y) { 
 static int level = 0; 
 switch(x) { 
 case 1: level ++; break ; 
 case 2: level -- ; break; 
 ...
 int __utac__cflow_t7ac_0 (int x, int y) { 
 static int level = 0; 
 switch(x) { 
 case 1: level ++; break ; 
 case 2: level -- ; break; 
