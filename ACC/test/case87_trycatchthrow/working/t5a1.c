...
#line 1 "t5a1.acc"
 inline void __utac_acc__t5a1__1(void) { 
...
#line 6 "t5a1.acc"
 inline void __utac_acc__t5a1__2(int e) {
...
#line 11 "t5a1.acc"
 inline void __utac_acc__t5a1__3(int e) {
...
#line 18 "t5a1.acc"
 inline void __utac_acc__t5a1__4(int e) {
...
#line 22 "t5a1.acc"
 inline void __utac_acc__t5a1__5(int e) {
...
#line 27 "t5a1.acc"
 inline void __utac_acc__t5a1__6(int e) {
...
printf("catch 5, exception = %d\n", e); }
 ...
 int __utac__cflow_t5a1_0 (int x, int y) { 
 static int level = 0; 
 switch(x) { 
 case 1: level ++; break ; 
 case 2: level -- ; break; 
