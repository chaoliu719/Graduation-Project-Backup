...
#line 1 "t3a4.acc"
 inline void __utac_acc__t3a4__1(void) { 
...
#line 7 "t3a4.acc"
 inline void __utac_acc__t3a4__2(int e) {
...
#line 11 "t3a4.acc"
 inline void __utac_acc__t3a4__3(int e) {
...
#line 15 "t3a4.acc"
 inline void __utac_acc__t3a4__4(void) { 
...
printf("after aspect for foo\n"); }
 ...
 int __utac__cflow_t3a4_0 (int x, int y) { 
 static int level = 0; 
 switch(x) { 
 case 1: level ++; break ; 
 case 2: level -- ; break; 
