...
#line 1 "t3a5.acc"
 inline void __utac_acc__t3a5__1(void) { 
...
#line 7 "t3a5.acc"
 inline void __utac_acc__t3a5__2(int e) {
...
#line 11 "t3a5.acc"
 inline void __utac_acc__t3a5__3(int e) {
...
#line 15 "t3a5.acc"
 inline void __utac_acc__t3a5__4(void) { 
...
printf("after aspect for foo\n"); }
 ...
 int __utac__cflow_t3a5_0 (int x, int y) { 
 static int level = 0; 
 switch(x) { 
 case 1: level ++; break ; 
 case 2: level -- ; break; 
