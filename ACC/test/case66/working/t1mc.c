...
# 518 "t1mc.c"
  ...
  char __utac_acc__t1ac__2 (  struct JoinPoint * );


static   char foo2 (int i  ) ; 
  char foo2utac__exec__ori (int i  ) ; 
void ** foo2_utac__exec__wrapper_t1mc_0 (struct JoinPoint * this);  
...
this.fp = &(foo2_utac__exec__wrapper_t1mc_0);
...
static inline char  foo__t1mc__0 (int i  )  ; 
...
# 654 "t1mc.c"
  ...
  char __utac_acc__t1ac__1 (  struct JoinPoint * );
