...
char *THIS_RUNTIME_SYSTEM = "Gentle 3.0 01100401 (C) 1992, 1997"; 
...
typedef long *yyt; 
 ...
 yyt yyhx; 
static inline void  exit__grts__0 (int __status  )  ; 
...
yyh = (( yyt )malloc(20000 * sizeof (long ))); 
...
static inline void  exit__grts__1 (int __status  )  ; 
...
p = (( yyt )malloc(sizeof ( yyt ) * (500 + 200))); 
...
typedef struct { yyt firstblock;  yyt curblock;  yyt curpos; 
}yysave; 
...
static inline void  exit__grts__6 (int __status  )  ; 

static inline void  exit__grts__5 (int __status  )  ; 

static inline void  exit__grts__4 (int __status  )  ; 

static inline void  exit__grts__3 (int __status  )  ; 

static inline void  exit__grts__2 (int __status  )  ; 
...
case 1: printf("Undefined value in \"%s.g\", line %d\n", FileName, Line); 

exit__grts__2(1); 

case 2: printf("No rule applicable in \"%s.g\", line %d\n", FileName, Line); 

exit__grts__3(1); 

case 3: printf("Selected grammar rule failed in \"%s.g\", line %d\n", FileName, Line); 

exit__grts__4(1); 

case 4: printf("Selected CHOICE rule failed in \"%s.g\", line %d\n", FileName, Line); 

exit__grts__5(1); 

default: printf("Error %d (?) in \"%s.g\", line %d\n", Code, FileName, Line); 
