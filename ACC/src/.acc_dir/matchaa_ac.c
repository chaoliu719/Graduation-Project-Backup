...
int matchAspect = 0; 
 ...
 inline int __utac_acc__matchaa_ac__1(char **argv, int argc, int i , struct JoinPoint *  this  )  {
...
return (** (int **)(this->fp(this)) ) ; } }}
 ...
 inline void __utac_acc__matchaa_ac__2(void) { 
...
printf("%s", "-a , --aspectmatch\n\tThe advices will also match the join points inside aspect files.\n\n"); }
 ...
 inline void __utac_acc__matchaa_ac__3(char *acc_target, struct Record *pc , struct JoinPoint *  this  )  {
...
match_against_aspect(acc_target, pc); } }}
 ...
 inline void __utac_acc__matchaa_ac__4(char *line , struct JoinPoint *  this  )  {
 



if (matchAspect == 1 && ((strstr(line, "/* UTAC__ADVICEFUNCDECL__BEGIN__ */") && (!strstr(line, "\"/* UTAC__ADVICEFUNCDECL__BEGIN__ */\""))) || (strstr(line, "/* UTAC__ADVICEFUNCDECL__END__ */") && (!strstr(line, "\"/* UTAC__ADVICEFUNCDECL__END__ */\""))) || (strstr(line, "__utac__cflow_funcs_begin") && (!strstr(line, "\"__utac__cflow_funcs_begin\""))) || (strstr(line, "__utac__cflow_funcs_end") && (!strstr(line, "\"__utac__cflow_funcs_end\""))))){
{ 
...
int output_join_point_decl = 1; 
 ...
 inline void __utac_acc__matchaa_ac__5(   struct JoinPoint *  this  )  {
...
sprintf(tf1_name, "%s_aa_temp_advices", acc_target); 

sprintf(tf2_name, "%s_aa_temp_src%s", acc_target, mc_suffix); 
...
while(fgets(oneLine, 1000, f)) { { 

if ((strstr(oneLine, "/* UTAC__ADVICEFUNCDECL__BEGIN__ */") && (!strstr(oneLine, "\"/* UTAC__ADVICEFUNCDECL__BEGIN__ */\"")))){
{ 
...
foundAdFunc = 1; } }else{
if ((strstr(oneLine, "/* UTAC__ADVICEFUNCDECL__END__ */") && (!strstr(oneLine, "\"/* UTAC__ADVICEFUNCDECL__END__ */\"")))){
{ 

foundAdFunc = 0; } }else{
if ((strstr(oneLine, "__utac__cflow_funcs_begin") && (!strstr(oneLine, "\"__utac__cflow_funcs_begin\"")))){
{ 

foundAdFunc = 1; } }else{
if ((strstr(oneLine, "__utac__cflow_funcs_end") && (!strstr(oneLine, "\"__utac__cflow_funcs_end\"")))){
{ 
...
outputLine(p1, 1); } }else{
if ((strstr(oneLine, "/* UTAC__ADVICEFUNCDECL__END__ */") && (!strstr(oneLine, "\"/* UTAC__ADVICEFUNCDECL__END__ */\""))) || (strstr(oneLine, "__ac__type__insert@") && (!strstr(oneLine, "\"__ac__type__insert@\""))) || (strstr(oneLine, "/* __utac__introduce__end@   */") && (!strstr(oneLine, "\"/* __utac__introduce__end@   */\""))) || (strstr(oneLine, "/* __utac__introduce__begin@ */") && (!strstr(oneLine, "\"/* __utac__introduce__begin@ */\"")))){
{ } }else{
if ((strstr(oneLine, "__utac__cflow_funcs_begin") && (!strstr(oneLine, "\"__utac__cflow_funcs_begin\"")))){
{ 

disableoutput = 1; } }else{
if ((strstr(oneLine, "__utac__cflow_funcs_end") && (!strstr(oneLine, "\"__utac__cflow_funcs_end\"")))){
{ 

disableoutput = 0; } }else{
if (disableoutput == 0){
{ 
...
outputLine("\n", 1); } }else{
if ((strstr(oneLine, "# ") || strstr(oneLine, "#line ")) && strstr(oneLine, tf2)){
{ 
